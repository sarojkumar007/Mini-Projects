(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const e of t)if(e.type==="childList")for(const s of e.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function o(t){const e={};return t.integrity&&(e.integrity=t.integrity),t.referrerPolicy&&(e.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?e.credentials="include":t.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function i(t){if(t.ep)return;t.ep=!0;const e=o(t);fetch(t.href,e)}})();function a(n,r=2){const o=10**r;return Math.round((n+Number.EPSILON)*o)/o}function M(n,r,o){const i=n*(r/1200)*(1+r/1200)**o/((1+r/1200)**o-1);return a(i)}const g=Intl.NumberFormat("en-US",{currency:"INR",style:"currency"}),L=Intl.DateTimeFormat("en-US",{month:"short",year:"numeric",day:"2-digit"}),c=n=>g.format(n),p=(n,r=!0)=>r?L.format(n):[n.getFullYear(),("0"+(n.getMonth()+1)).slice(-2),("0"+n.getDate()).slice(-2)].join("-");function b(){document.querySelector("#start-date").min=p(new Date,!1),document.querySelector("#emi_form").addEventListener("submit",n=>{n.preventDefault();const r=parseFloat(document.querySelector("#principal").value??0),o=parseFloat(document.querySelector("#roi").value??0),i=parseFloat(document.querySelector("#tenure").value??0),t=document.querySelector("#start-date").value,e=M(r,o,i),s=a(e*i-r),y=a(e*i),v=[];let l=`<table class="styled_table">
      ...
      <tbody>`;const d=new Date(t);let u=r;for(let m=1;m<=i;m++){const f=u*(o/1200),h=e-f;u-=h,v.push([p(d),Math.round(Math.abs(u)),a(h),a(f)]),l+=`<tr>
        <td>${m}</td>
        <td>${p(d)}</td>
